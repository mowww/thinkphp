...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-08-06 09:08:20
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `admin` (`admin_id`, `username`, `password`, `lastloginip`, `lastlogintime`, `email`, `realname`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  `parentid` smallint(6) NOT NULL DEFAULT '0' COMMENT '多级菜单的上级菜单id',
  `m` varchar(20) NOT NULL DEFAULT '',
  `c` varchar(20) NOT NULL DEFAULT '',
  `f` varchar(20) NOT NULL DEFAULT '',
  `data` varchar(100) NOT NULL DEFAULT '',
  `listorder` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '排序顺序',
  `status` tinyint(1) NOT NULL DEFAULT '1',
...
INSERT INTO `menu` (`menu_id`, `name`, `parentid`, `m`, `c`, `f`, `data`, `listorder`, `status`, `type`) VALUES
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  `small_title` varchar(30) NOT NULL DEFAULT '' COMMENT '文章副标题',
...
INSERT INTO `news` (`news_id`, `catid`, `title`, `small_title`, `title_font_color`, `thumb`, `keywords`, `description`, `posids`, `listorder`, `status`, `copyfrom`, `username`, `create_time`, `update_time`, `count`) VALUES
...
(28, 2, '习近平今日下午出席解放军代表团全体会议', '/upload/2016/03/13/56e519a185c93.png', '', 21, 0, 1, 1457854896, 0),
...
(25, 3, 'test', '/upload/2016/03/06/56dbdc0c483af.JPG', '', 17, 0, -1, 1455756856, 0),
(23, 2, 'test', '/upload/2016/03/06/56dbdc0c483af.JPG', '', 17, 1, -1, 1455756856, 0),
(24, 2, '你好ssss', '/upload/2016/03/06/56dbdc015e662.JPG', '', 18, 2, -1, 1455756999, 0),
(29, 3, '李克强让部长们当第一新闻发言人', '/upload/2016/03/13/56e51b6ac8ce2.jpg', '', 22, 12, 1, 1457855362, 0),
(30, 3, '重庆美女球迷争芳斗艳', '/upload/2016/03/13/56e51cbd34470.png', '', 23, 0, 1, 1457855680, 0),
(31, 3, '中超-汪嵩世界波制胜 富力客场1-0力擒泰达', '/upload/2016/03/13/56e51fc82b13a.png', '', 24, 0, 1, 1457856460, 0),
