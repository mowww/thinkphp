            ...
            <form action="/admin.php" method="get">
                ...
                <div class="input-group" >
                    ...
                    <select class="form-control" name="type">
                        <option value='3'<?php if($type == 3): ?>selected<?php endif; ?>>请选择类型</option>
                ...
                <div class="table-responsive" >
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                <td><input size="4" type="text" name='listorder[<?php echo ($menu["menu_id"]); ?>]' value="<?php echo ($menu["listorder"]); ?>" style="text-align:center"/></td>
