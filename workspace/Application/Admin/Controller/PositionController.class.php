    ...
    public function add() {
        if(IS_POST) {
            ...
            try {
                ...
                if($id) {
                    return json_show(1,'新增成功',$id);
                }
                return json_show(0,'新增失败',$id);


            }catch(Exception $e) {
                return json_show(0, $e->getMessage());
            }
            return json_show(0, '新增失败',$newsId);
        }else {
            $this->display();
        }
    ...
    public function setStatus(){
        try {
            if ($_POST) {
                ...
                if ($res) {
                    return json_show(1, '操作成功');
                } else {
                    return json_show(0, '操作失败');
                }
